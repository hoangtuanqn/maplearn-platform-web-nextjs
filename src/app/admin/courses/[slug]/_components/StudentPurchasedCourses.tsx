            ...
            <div className="mb-6">
                <div className="mb-4 flex flex-col justify-between gap-3 lg:flex-row lg:items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-gray-900 lg:text-xl">Học viên đăng ký khóa học</h3>
                            <p className="text-sm text-gray-600 lg:hidden">Danh sách học viên đã đăng ký</p>
                        </div>
                    </div>
                ...
                <p className="hidden text-gray-600 lg:block">Danh sách tất cả học viên đã đăng ký khóa học này</p>
            </div>
            ...
            <div>
                        ...
                        : studentsData?.data.map((student, idx) => (
                              ...
                              >
                                  ...
                                  <div className="mb-4 rounded-lg bg-gray-50 p-3">
                                      <h4 className="mb-2 text-sm font-medium text-gray-900">Tiến độ học tập</h4>
                                  ...
                                  <div className="mb-4 grid grid-cols-2 gap-3">
                                      {/* Weekly Stats */}
                                      <div className="space-y-2">
                                          <div className="rounded bg-green-50 px-2 py-2 text-center">
                                              <div className="text-sm font-medium text-green-700">
                                                  {student.lessons_in_week}
                                              </div>
                                              <div className="text-xs text-green-500">bài học tuần này</div>
                                          </div>
                                          <div className="rounded bg-purple-50 px-2 py-2 text-center">
                                              <div className="text-sm font-medium text-purple-700">
                                                  {student.hours_in_week}h
                                              </div>
                                              <div className="text-xs text-purple-500">học tuần này</div>
                                          </div>
                                      </div>

                                      {/* Exam & Certificate */}
                                      <div className="space-y-2">
                                          <div className="rounded bg-gray-50 px-2 py-2 text-center">
                                              <div className="text-xs font-medium text-gray-700">
                                                  {student.exam_required ? "Có bài thi" : "Không có bài thi"}
                                              </div>
                                              {student.exam_required && (
                                                  <div
                                                      className={`text-xs ${student.exam_passed ? "text-green-600" : "text-red-600"}`}
                                                  >
                                                      {student.exam_score ? (
                                                          <>
                                                              {student.exam_passed
                                          ...
                                          <div className="rounded bg-amber-50 px-2 py-2 text-center">
                                              <div className="text-xs font-medium text-amber-700">
                                                  {student.certificate_code ? "Có chứng chỉ" : "Chưa có chứng chỉ"}
                                              </div>
                                              {student.certificate_code && (
                ...
                {!isLoading && studentsData?.data.length === 0 && (
                    <div className="py-12 text-center">
                        <div className="mx-auto mb-4 h-16 w-16 text-gray-400 lg:h-24 lg:w-24">
