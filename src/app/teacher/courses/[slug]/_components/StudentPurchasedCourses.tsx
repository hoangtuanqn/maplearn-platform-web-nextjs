...
import DisplayTotalResult from "~/app/teacher/_components/DisplayTotalResult";
                                  ...
                                  <tr key={student.id} className="transition-colors hover:bg-gray-50">
                                      ...
                                      <td className="px-4 py-4 text-right">
                                          <div className="flex flex-row items-center justify-end gap-2">
                                              ...
                                              <Link
                                                  href={`/teacher/courses/${slug}/students/${student.id}`}
                                                  target="_blank"
                                              >
            ...
            {totalPages > 1 && (
                <div className="mt-6 flex w-full">
                    <div className="ml-auto">
                        <Suspense>
                            <PaginationNav totalPages={totalPages} basePath={`/teacher/courses/${slug}`} />
                        </Suspense>
                    </div>
                </div>
            )}
