            ...
            <div className="flex h-full gap-0 max-lg:flex-col">
                ...
                <div className="flex-12/15">
                    ...
                    <div className="bg-black">
                        <VideoPlayer src={lesson.video_url} ratio="16:6" />
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 flex items-center gap-2 text-sm text-gray-600">
                                        <span className="inline-flex items-center gap-1 rounded-full bg-blue-100 px-2 py-1 text-xs text-blue-700">
                                            Bài {lesson.position}/{" "}
                                            {course.chapters[lesson.chapter.id - 1].lessons.length}
                                        </span>
                                        <span className="text-gray-400">•</span>
                                        <span>Chương {lesson.chapter.position}</span>
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="bg-white">
                        <div className="p-6 max-lg:p-4">
                            ...
                            <div className="mb-6 flex flex-wrap items-center gap-6 text-sm">
                                ...
                                <span className="text-gray-400">•</span>
                                <span className="text-gray-600">Last updated {formatter.date(course.updated_at)}</span>
                            </div>
