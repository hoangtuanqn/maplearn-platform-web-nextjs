    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-gray-900">Bình luận bài học</h3>
                ...
                <div className="rounded-xl border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-6 shadow-sm">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            <h4 className="mb-3 font-semibold text-gray-900">Viết bình luận của bạn</h4>
                            <textarea
                                value={newComment}
                                onChange={(e) => setNewComment(e.target.value)}
                                placeholder="Chia sẻ ý kiến, cảm nhận của bạn về bài học này..."
                                className="w-full resize-none rounded-lg border border-gray-300 p-4 transition-colors outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                                rows={3}
                            />
                            <div className="mt-4 flex items-center justify-between">
                                <span className="text-sm text-gray-500">
                                    Hãy bình luận một cách tích cực và xây dựng
                                </span>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                <textarea
                                                    ...
                                                    className="w-full resize-none rounded-lg border border-gray-300 p-3 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                                                    rows={2}
                                                />
