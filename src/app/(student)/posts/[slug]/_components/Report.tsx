    ...
    const reportMutation = useMutation({
        mutationFn: (data: ReportFormData) => {
            return reportApi.report({
                reportable_type: "post", // hoặc "post" nếu cần
                        ...
                        <div className="mt-6 grid gap-3.5">
                            <div className="grid gap-3">
                                ...
                                <Select onValueChange={(value) => setValue("reason", value)}>
                                    ...
                                    <SelectContent>
                                        <SelectGroup>
                                            <SelectItem value="spam">Nội dung spam / quảng cáo</SelectItem>
                                            <SelectItem value="misleading">Thông tin sai lệch</SelectItem>
                                            <SelectItem value="hate_speech">Ngôn từ thù ghét / kích động</SelectItem>
                                            <SelectItem value="harassment">Quấy rối / công kích cá nhân</SelectItem>
                                            <SelectItem value="violence">Kích động bạo lực</SelectItem>
                                            ...
                                            <SelectItem value="irrelevant">Không liên quan đến chủ đề</SelectItem>
                                            <SelectItem value="duplicate">Bài viết trùng lặp</SelectItem>
