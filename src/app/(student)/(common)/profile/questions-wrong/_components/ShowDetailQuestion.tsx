...
const ShowDetailQuestion = ({ question }: { question: QuestionWrongProfileResponse["data"]["data"][number] }) => {
    return (
        <Dialog>
            ...
            <DialogContent className="min-w-[30%] bg-white">
                <DialogHeader>
                    <DialogTitle>Đề thi: {question.question.exam_paper.title}</DialogTitle>
                    <DialogDescription>
                    ...
                    <div className="mt-4 flex items-center gap-2 text-[16.125px]">
